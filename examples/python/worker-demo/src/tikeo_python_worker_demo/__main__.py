...
def configure_scripts(config: tikeo.WorkerConfig) -> tikeo.ScriptRunnerRegistry:
    ...
    resolver = tikeo.SandboxToolResolver(state_dir=env_or("TIKEO_WORKER_STATE_DIR", ""), auto_install=not disabled("TIKEO_SANDBOX_AUTO_INSTALL"), strict_sandbox_isolation=enabled("TIKEO_SANDBOX_STRICT_ISOLATION"))
