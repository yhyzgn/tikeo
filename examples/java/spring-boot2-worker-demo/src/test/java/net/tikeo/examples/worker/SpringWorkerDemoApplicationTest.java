...
@SpringBootTest(webEnvironment = SpringBootTest.WebEnvironment.RANDOM_PORT, properties = {
        ...
        "tikeo.worker.state-dir=${java.io.tmpdir}/spring-boot2-worker-demo-test",
        "tikeo.worker.client-instance-id=spring-boot2-worker-demo-test",
        ...
        "tikeo.worker.labels.demo=spring-boot2-worker-demo"
})
class SpringWorkerDemoApplicationTest {
    ...
    void dryRunClientUsesGeneratedIdentityAndStartsWithLifecycle() {
        ...
        Assertions.assertThat(noop.workerId()).isEqualTo("dry-run-spring-boot2-worker-demo-test");
        Assertions.assertThat(noop.registration().clientInstanceId()).isEqualTo("spring-boot2-worker-demo-test");
        ...
        Assertions.assertThat(noop.registration().labels()).containsEntry("worker_pool", "demo-pool")
                ...
                .containsEntry("demo", "spring-boot2-worker-demo");
    ...
    void exposesStandardSpringBootWebDemoEndpoints() throws Exception {
        ...
        Assertions.assertThat(health).contains("\"workerId\":\"dry-run-spring-boot2-worker-demo-test\"");
