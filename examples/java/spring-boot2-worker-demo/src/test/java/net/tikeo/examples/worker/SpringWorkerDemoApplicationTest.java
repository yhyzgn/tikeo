...
class SpringWorkerDemoApplicationTest {
    ...
    void dryRunClientUsesGeneratedIdentityAndStartsWithLifecycle() {
        ...
        assertThat(noop.workerId()).isEqualTo("dry-run-spring-boot2-worker-demo-test");
        assertThat(noop.registration().clientInstanceId()).isEqualTo("spring-boot2-worker-demo-test");
    ...
    void exposesStandardSpringBootWebDemoEndpoints() throws Exception {
        ...
        assertThat(health).contains("\"workerId\":\"dry-run-spring-boot2-worker-demo-test\"");
