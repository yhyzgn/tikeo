...
@SpringBootTest(webEnvironment = SpringBootTest.WebEnvironment.RANDOM_PORT, properties = {
        ...
        "tikee.worker.state-dir=${java.io.tmpdir}/spring-boot2-worker-demo-test",
        "tikee.worker.client-instance-id=spring-boot2-worker-demo-test",
        ...
        "tikee.worker.labels.demo=spring-boot2-worker-demo"
})
