...
curl -X POST http://127.0.0.1:18083/demo/jobs/echo
curl -X POST http://127.0.0.1:18083/demo/jobs/plugin/sql
curl -X POST http://127.0.0.1:18083/demo/jobs/script/script_manual_shell_echo
```
