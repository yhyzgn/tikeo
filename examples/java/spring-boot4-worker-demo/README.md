...
This demo validates the Tikeo Java SDK and the Spring Boot 4.x starter line with `tikeo-spring-boot-starter`.
...
curl -X POST http://127.0.0.1:18084/demo/jobs/echo
curl -X POST http://127.0.0.1:18084/demo/jobs/plugin/sql
curl -X POST http://127.0.0.1:18084/demo/jobs/script/script_manual_shell_echo
```
