...
class SpringWorkerDemoApplicationTest {
    ...
    void dryRunClientUsesGeneratedIdentityAndStartsWithLifecycle() {
        ...
        Assertions.assertThat(noop.workerId()).isEqualTo("dry-run-spring-boot4-worker-demo-test");
        Assertions.assertThat(noop.registration().clientInstanceId()).isEqualTo("spring-boot4-worker-demo-test");
    ...
    void exposesStandardSpringBootWebDemoEndpoints() throws Exception {
        ...
        Assertions.assertThat(health).contains("\"workerId\":\"dry-run-spring-boot4-worker-demo-test\"");
