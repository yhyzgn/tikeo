...
class EchoProcessorTest {
    ...
    void echoTaskHandlesApiPayload() throws Exception {
        ...
        assertThat(echo).isEqualTo("echo:hello");
    ...
    void bytesTaskHandlesRawPayload() throws Exception {
        ...
        assertThat(bytes).isEqualTo("bytes:abc");
        assertThat(taskLogs).contains(
    ...
    void scheduledAndWorkflowTasksReturnSuccessOutcomes() throws Exception {
        ...
        assertThat(captured("demo.heartbeat", "", heartbeatLogs, context -> new HeartbeatTaskProcessor().heartbeat(context)).success()).isTrue();
        ...
        assertThat(captured("demo.report", "", reportLogs, context -> new ReportTaskProcessor().report(context)).message()).isEqualTo("report:demo.report");
        ...
        assertThat(captured("demo.workflow.step", "", workflowLogs, context -> new WorkflowStepTaskProcessor().workflowStep(context)).message())
