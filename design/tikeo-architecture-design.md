...
- [x] 独立文档站与 CI 验证（2026-06-10：`website/` Docusaurus 文档站已接入主 CI `Docs site` job，运行 docs contract、Bun frozen install、typecheck 与 build；`website/bun.lock` 使用公开 npm registry tarball URL，避免 GitHub Actions 依赖私有 npm 代理凭证）
