...
- [ ] Prometheus 指标 + Grafana Dashboard 模板
  ...
  - [ ] 完整业务 SLO 指标（端到端调度延迟 histogram、真实 scrape/recording-rule 校验等）
- [ ] OpenTelemetry 分布式追踪
