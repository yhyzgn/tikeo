...
发布签核或开发交接时，使用文档站中的[产品就绪验收清单](https://docs.tikeo.net/zh-CN/docs/development/product-readiness-acceptance)。它把最容易停留在“看起来能用”的三块能力统一成证据门槛：
...
证据包应随 release 或交接记录保存：命令或 UI 动作、检查的路由/文件、观察到的结果和产物路径。
