...
| 9 | [v0.3.10 发布验收包](./development/release-acceptance-packet-v0.3.10) | 具体 release/交接证据：原地迁移 apply、assets、CI、Kind HA 指标、跨语言 Worker soak 和剩余检查。 |
| 10 | [v0.3.9 发布验收包](./development/release-acceptance-packet-v0.3.9) | 历史 v0.3.9 release/交接证据。 |
...
- `web/` 是 React + TypeScript + Vite + Ant Design + Bun 的控制台，包含实时 Dashboard 驾驶舱、Jobs、Instances、Worker Mesh、Workflows、Scripts、通知中心、Security Policy Center、Audit 和 RBAC 设置。
