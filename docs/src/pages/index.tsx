...
const copy: Record<'en' | 'zh-CN', LocaleCopy> = {
  en: {
    ...
    description: 'Human-readable Tikeo manuals for task scheduling, distributed task scheduling, high-performance scheduler design, workflow orchestration, outbound Worker Tunnel operations, SDK integration, deployment, configuration, and governance.',
  ...
  'zh-CN': {
    title: 'Tikeo 运维手册',
    description: '面向人的 Tikeo 文档：任务调度、高性能分布式调度器、工作流编排、出站 Worker Tunnel、SDK 集成、部署、配置、治理与运维验收。',
    eyebrow: 'Tikeo 文档',
