...
- Continue with `.prompt/091-phase3-alert-provider-delivery-foundation.md`.
- Focus areas:
  1. Add the next smallest locally verifiable Phase 3 alerting hardening slice.
  2. Prefer provider/channel delivery readiness, redacted config/status, or deterministic no-network dispatch records before real external webhook/email delivery.
