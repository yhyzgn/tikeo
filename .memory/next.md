...
- Remaining alert delivery hardening: production SMTP TLS/auth/secret handling, continuous background retry worker scheduling, and live provider smoke for external SMTP/Slack/DingTalk/Feishu/WeCom/PagerDuty endpoints.
