...
- Remaining alert delivery hardening: email/SMTP, retry/backoff/DLQ, persisted delivery attempts, and live provider smoke for external Slack/DingTalk/Feishu/WeCom/PagerDuty endpoints.
