...
- Remaining alert delivery hardening: production SMTP TLS/auth/secret handling, retry/backoff/DLQ processing, and live provider smoke for external SMTP/Slack/DingTalk/Feishu/WeCom/PagerDuty endpoints.
