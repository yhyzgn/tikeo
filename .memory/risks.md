...
- Alerting has durable rules/events/recovery/summary, redacted channel readiness, production-guarded webhook POST delivery, provider-specific Slack/DingTalk/Feishu/WeCom/PagerDuty JSON adapters, and persisted delivery attempt history; email/SMTP, retry/backoff/DLQ processing, and live external provider smoke remain future work.
