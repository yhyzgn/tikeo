...
- Alerting has durable rules/events/recovery/summary, redacted channel readiness, and production-guarded real webhook POST delivery; non-webhook providers, retries/DLQ, and persisted delivery attempts remain future work.
