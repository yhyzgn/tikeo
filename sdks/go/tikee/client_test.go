...
`, shellQuote(report), shellQuote(report), shellQuote(report), shellQuote(report), shellQuote(report)))
			...
			if !strings.Contains(values["home"], "tikee-srt-"+normalizeScriptLanguage(tc.language)+"-runtime") {
...
`, shellQuote(report), shellQuote(report), shellQuote(report), shellQuote(report), shellQuote(report)))
			...
			if !strings.Contains(values["home"], "tikee-deno-"+normalizeScriptLanguage(language)+"-runtime") {
				t.Fatalf("home=%q, want task runtime dir", values["home"])
			}
