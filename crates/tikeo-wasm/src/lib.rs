...
use thiserror::Error;
use tikeo_core::{WasmCapabilities, WasmProcessorSpec, WasmSpecError};
...
impl WasmExecutor {
    ...
    /// Execute a module with the provided tikeo WASM policy.
    ///
    ...
    fn fuel_limit_interrupts_busy_loop() {
        ...
        let module = wat(r#"(module
              (func (export "_start")
                (loop br 0)))"#);
        let spec = WasmProcessorSpec {
            resources: tikeo_core::WasmResourcePolicy {
                fuel: 10,
                ..tikeo_core::WasmResourcePolicy::default()
            },
            ..WasmProcessorSpec::default()
        };
