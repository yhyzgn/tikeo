//! Core domain types shared by tikeo crates.
...
pub enum TriggerType {
    ...
    /// CRON tikeo trigger.
    Cron,
    /// Fixed-rate tikeo trigger.
    FixedRate,
    /// Fixed-delay tikeo trigger.
    FixedDelay,
    /// One-shot future tikeo trigger.
    Once,
    /// Daily time-window interval tikeo trigger.
    DailyTimeInterval,
