...
pub async fn list_plugins(
    ...
    headers: HeaderMap,
) -> Result<Json<ApiResponse<Vec<tikeo_storage::PluginSummary>>>, ApiError> {
...
pub async fn create_plugin(
...
) -> Result<Json<ApiResponse<tikeo_storage::PluginSummary>>, ApiError> {
    ...
    let created = state
        .plugins
        .create_plugin(tikeo_storage::CreatePlugin {
            name: request.name,
            kind: request.kind,
...
fn validate_plugin_declaration(
    processors: &[tikeo_storage::PluginProcessorTypeSummary],
    channels: &[tikeo_storage::PluginAlertChannelTypeSummary],
) -> Result<(), ApiError> {
    validate_processor_types(processors)?;
    validate_alert_channel_types(channels)
}
