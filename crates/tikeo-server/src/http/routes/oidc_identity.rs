...
use tikeo_storage::{OidcIdentityRepository, UpsertOidcIdentity};
...
pub async fn list_oidc_identities(
    ...
    headers: HeaderMap,
) -> Result<Json<ApiResponse<Vec<tikeo_storage::OidcIdentitySummary>>>, ApiError> {
...
) -> Result<Json<ApiResponse<tikeo_storage::OidcIdentitySummary>>, ApiError> {
