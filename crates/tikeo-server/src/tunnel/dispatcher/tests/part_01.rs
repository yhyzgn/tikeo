        ...
        registry
            .register(
                RegisterWorker {
                    ...
                    region: "local".to_owned(),
                    capabilities: Vec::new(),
                    structured_capabilities: Some(normal_capabilities("demo.echo")),
                    election: None,
                    labels: HashMap::default(),
                },
                tx,
        ...
        let worker = registry
            .register(
                RegisterWorker {
                    ...
                    region: "local".to_owned(),
                    capabilities: Vec::new(),
                    structured_capabilities: Some(normal_capabilities("demo.retry")),
                    election: None,
                    labels: HashMap::default(),
                },
                tx,
        ...
        registry
            .register(
                RegisterWorker {
                    ...
                    region: "local".to_owned(),
                    capabilities: Vec::new(),
                    structured_capabilities: Some(normal_capabilities("manual")),
                    election: None,
                    labels: HashMap::default(),
                },
                tx1,
