...
use tikeo_storage::{RaftRepository, UpsertRaftMember, UpsertRaftMetadata};
...
pub struct ClusterStatus {
    ...
    pub nodes: u32,
    /// Whether this node may own tikeo/dispatcher loops.
...
mod tests {
    ...
    async fn raft_config_status_is_unknown_and_not_schedulable() {
        ...
        assert_eq!(status.node_id, "tikeo-1");
