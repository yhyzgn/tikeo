...
pub struct MenuPermissionCatalogItem {
    ...
    pub required_permission: Option<tikee_storage::PermissionSummary>,
}
...
pub async fn list_roles(
    ...
    headers: HeaderMap,
) -> Result<Json<ApiResponse<Vec<tikee_storage::RoleSummary>>>, ApiError> {
...
pub async fn create_role(
...
) -> Result<Json<ApiResponse<tikee_storage::RoleSummary>>, ApiError> {
    ...
    let created = state
        .rbac
        .create_role(tikee_storage::CreateRole {
...
pub async fn permission_catalog(
    State(state): State<Arc<AppState>>,
    headers: HeaderMap,
) -> Result<Json<ApiResponse<Vec<tikee_storage::PermissionCatalogItem>>>, ApiError> {
    auth::require_permission(&headers, &state, "roles", "read").await?;
...
fn permission_summary((resource, action): (&str, &str)) -> tikee_storage::PermissionSummary {
    tikee_storage::PermissionSummary {
