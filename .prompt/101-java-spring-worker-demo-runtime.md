...
3. Make the live local endpoint use `127.0.0.1:9998` and document the command that registers with a local tikeo server.
...
- local tikeo server + live Java demo show one online worker via `/api/v1/workers`
