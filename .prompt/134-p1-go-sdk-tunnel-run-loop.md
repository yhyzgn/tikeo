...
## Context
Go SDK official gRPC/protobuf foundation is now in place: `sdks/go/tikeo` validates config, exposes registration/heartbeat/task processor shapes, vendors the Worker Tunnel proto, creates official `grpc.ClientConn`, and includes generated Worker Tunnel client bindings under `internal/workerpb`. Generated protobuf output is split into sub-1500-line package files to respect the repository file-size rule.
